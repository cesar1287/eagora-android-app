...
public class Utility {
    ...
    public static final String URI_PACKAGE = "android.resource://harmonytech.praagoraa/";
    ...
    public static SpannableString changeActionBarTitle(Activity activity, String title){
        ...
        spannableString.setSpan(new harmonytech.praagoraa.controller.util.TypefaceSpan(activity.getApplicationContext(),
